...
#else
  TimerTime_t CalendarData;
  TimerTime_t CalendarTime;
#endif
} RtcCalendar_t;
...
TimerTime_t RtcGetTimerValue( void )
{
    ...
    // #warning RtcGetTimerValue() returning 0
    return( 0 );
...
TimerTime_t RtcGetElapsedAlarmTime( void )
{
    ...
    // #warning RtcGetElapsedAlarmTime() returning 0
    return( 0 );
...
#else
    // #warning RtcComputeFutureEventTime() returning 0
    return( 0 ) ;
#endif
}
...
#else
    // #warning RtcComputeElapsedTime() returning 0
    return( 0 ) ;
#endif
}
...
static RtcCalendar_t RtcComputeTimerTimeToAlarmTick( TimerTime_t timeCounter, RtcCalendar_t now )
{
  ...
  #else
    // #warning RtcComputeTimerTimeToAlarmTick() returning 0
  #endif
...
#else
    RtcCalendar_t now = {  0 ,  0  };
    return ( now );
    // #warning RtcGetCalendar() returning 0
#endif
    return( now );
}
